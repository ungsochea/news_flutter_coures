        ...
        child: ListView(children: [
          DrawerHeader(
            ...
            child: Column(
              ...
              children: [
                Flexible(child: Image.asset('assets/images/newspaper.png',width: 60,height: 60,)),
...
class ListTileWidget extends StatelessWidget {
  const ListTileWidget({Key? key, required this.label, required this.fct, required this.icon}) : super(key: key);
  final String label;
  final Function fct;
  final IconData icon;
  @override
